...
const files={'/shared-header.css':'shared-header.css','/rack-export.js':'rack-export.js','/':'index.html','/index.html':'index.html','/style.css':'style.css','/app.js':'app.js','/label-layout.js':'label-layout.js','/racks.html':'racks.html','/racks.css':'racks.css','/racks.js':'racks.js','/rack-model.js':'rack-model.js'};
